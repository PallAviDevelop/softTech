...
import vg from "../assets/about.jpeg";
import {
  AiFillGoogleCircle,
  AiFillAmazonCircle,
  AiFillYoutube,
  ...
  return (
    <>
      ...
      <div className="home2">
        ...
        <div>
          <p>
          We enhance overall effectiveness and efficiency using next generation technology. Our focus is to help you envision potential, leverage technology and reach for infinite growth.
          </p>
        </div>
      </div>
